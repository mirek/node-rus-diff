(function() {
  var apply, arrize, clone, diff, isRealNumber, jsonHash, resolve,
    __slice = [].slice;
  ...
  diff = function(a, b, stack, options, top, garbage) {
    var aI, aKey, aKeys, aN, aVal, bI, bKey, bKeys, bN, bVal, collect, delta, e, h, incA, k, k2, key, setB, unsetA, v, v2, _i, _len, _ref;
    if (stack == null) {
      stack = [];
    }
    if (options == null) {
    ...
    if (top) {
      collect = (function() {
        ...
        for (k in _ref1) {
          v = _ref1[k];
          if ((h = jsonHash.digest(v), (garbage[h] != null) && (key = garbage[h].pop()))) {
            _results.push([k, key]);
          }
        }
        return _results;
